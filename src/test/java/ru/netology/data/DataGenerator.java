...
public class DataGenerator {
    ...
    private static String getOwnerRus() {
    ...
    public static CardInfo getCardWithRussianSymbolsOwner() {
        return new CardInfo(validCard, getValidMonth(), getValidYear(), getOwnerRus(), getCVC());
    }
